...
def face_reply(msg):
    # print(msg)
    result = face_auto.face(msg)
    # print(result)
    return result



def baidu_result(msg):
    # print(msg)
    result = baidu_shibie.image_identify(msg)  # 调用baidu_shibie的image_identify方法
    return result
...
def keyword_reply(msg):
    """关键字回复"""
    if '你叫啥' in msg.text or '你叫啥名字' in msg.text or '你是谁' in msg.text or '?' in msg.text:
        return msg.reply('猪妹')
    elif '我爱你' in msg.text:
        return msg.reply('我也爱你')
    elif '你说什么' in msg.text or '再说一遍' in msg.text:
        return msg.reply('我说我爱你')
    pass
